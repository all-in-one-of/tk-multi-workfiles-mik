...
class WorkFiles(object):
    ...
    def find_files(self, filter):
        ...
        # return finder.find_files(self._work_area_template, self._publish_template, find_ctx)
    ...
    def _get_next_available_version(self, work_path, publish_path):
        ...
        # found_files = finder.find_files(self._work_area_template, self._publish_template, self._context, file_key)

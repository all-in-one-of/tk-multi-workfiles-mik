...
class WorkFiles(object):
    ...
    def _get_app_settings_for_context(self, context):
        ...
        self._app.log_debug("context: %s"%context)
        self._app.log_debug("self._app.engine.name: %s"%self._app.engine.name)
        self._app.log_debug("self._app.name: %s"%self._app.name)
        self._app.log_debug("self._app.tank: %s"%self._app.tank)
        other_settings = tank.platform.find_app_settings(self._app.engine.name, self._app.name, self._app.tank, context)
        self._app.log_debug("other_settings: %s"%other_settings)
        ...
        self._app.log_debug("settings_by_engine: %s"%settings_by_engine)
        ...
        for instance_name, engine_app in self._app.engine.apps.iteritems():
            self._app.log_debug("instance_name, engine_app: %s, %s"%instance_name,engine_app)
            if engine_app == self._app:
                app_instance_name = instance_name
                break
        self._app.log_debug("app_instance_name: %s"%app_instance_name)

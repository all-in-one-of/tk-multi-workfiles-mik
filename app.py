...
class MultiWorkFiles(tank.platform.Application):
    ...
    def show_file_manager_dlg(self):
        ...
        """
        tk_multi_workfiles_mik = self.import_module("tk_multi_workfiles_mik")
        tk_multi_workfiles_mik.WorkFiles.show_file_manager_dlg(self)
    ...
    def show_change_work_area_dlg(self, enable_start_new=True):
        ...
        """
        tk_multi_workfiles_mik = self.import_module("tk_multi_workfiles_mik")
        tk_multi_workfiles_mik.WorkFiles.show_change_work_area_dlg(self, enable_start_new)
    ...
    def show_save_as_dlg(self):
        ...
        if self._can_save_as:
            tk_multi_workfiles_mik = self.import_module("tk_multi_workfiles_mik")
            return tk_multi_workfiles_mik.SaveAs.show_save_as_dlg(self)
        else:
            return False
    ...
    def show_change_version_dlg(self):
        ...
        if self._can_change_version:
            tk_multi_workfiles_mik = self.import_module("tk_multi_workfiles_mik")
            return tk_multi_workfiles_mik.Versioning.show_change_version_dlg(self)
        else:
            return False
